...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><img src="<?php echo $vo['img']; ?>" width="140" height="240"></td>
