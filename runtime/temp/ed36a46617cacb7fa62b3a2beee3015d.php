...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><img src="<?php echo $vo['appguanggaoimg']; ?>" width="180" height="80"></td>
