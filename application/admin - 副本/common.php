...
/**
 * 是否推荐 
 * @param int $is_tuijian     0正常  1推荐
 * @param bool $imageShow true只显示图标|false只显示文字
 * @return string
 */
function get_is_tuijian($is_tuijian)
{
    switch ($is_tuijian) {
        case 0 :
            $showText = '<span class="Hui-iconfont c-warning">&#xe631;</span>';//黄色查查
            
            break;
        case 1 :
            $showText = '<span class="Hui-iconfont c-success">&#xe615;</span>';  //绿色对号
            break;
...
function get_is_zhiding($is_zhiding,$imageShow = true){
    // &#xe631; huang 
    // &#xe615; lv
    switch ($is_zhiding) {
        case 1 :
            ...
            break;
        case 0 :
            $showText = '<span class="Hui-iconfont c-warning">&#xe631;</span>'; //
            break;
...
function get_quanxian($rank){
    switch ($rank) {
        case 0 :
            $showText = '<span >单图</span>';
            break;
        case 1 :
            $showText = '<span class="Hui-iconfont c-warning">多图</span>';
            break;
    }
    return $showText;
}
